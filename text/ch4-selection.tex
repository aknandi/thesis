...
Partially reconstructed decays refer to those in which one or more particle has failed to be reconstructed. These decays are parameterised by analytic functions based on a previous study of \decay{\Bm}{\D\Km}, \decay{\D}{h^+h^-} data, which has many similar aspects to this analysis.
