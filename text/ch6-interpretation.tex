...
In order to estimate $\kappa$ an amplitude model is developed, containing resonant and non-resonant decays that are expected to contribute to in the region of phasespace considered in this analysis to select \btodkst decays. The amplitude model can be used to calculate the value of the parameter $\kappa$. The model is generated many times, each time with the amplitudes and phases of the model components varied within estimated uncertainties. This results in a distribution in the estimates of $\kappa$ for this analysis.

\subsection{Decay model}
\label{sec:interpretation:model}

In order to estimate $\kappa$ an amplitude model is developed, containing resonant and non-resonant decays that are expected to contribute to in the region of phasespace considered in this analysis to select \btodkst decays. The components of the model used for this study are:
...
The role of $\kappa$ in \btodkst decays is detailed in Section \ref{sec:theory:gamma}, where the definition of $\kappa$ is given by Equation \ref{kappadefinition}. The magnitudes $A_{\uquark\bquark}$ and $A_{\cquark\bquark}$ represent the amplitude of the suppressed and favoured \decay{\Bm}{\D X^-} decays, where $X^-$ represents a resonant or non-resonant \KS\pim pair. The amplitudes $A_{\uquark\bquark}$ and $A_{\cquark\bquark}$ are modelled as,
...
Figure \ref{dalitzplot} shows an example amplitude model used in the estimate of $\kappa$. The \Kstar selection in this analysis, consisting of the \Kstar mass and \KS helicity angle requirements, are represented by dashed lines in this plot.
