...
An additional source of background is present in the \kk mass spectrum from \decay{\Lb}{\Lc\Kstarm} decays, described in Section \ref{sec:backgrounds:Lb2LcKst}. The shape used to model this \decay{\Lb}{\Lc\Kstarm} contribution is a Cruijff PDF, defined as,
\begin{equation}
