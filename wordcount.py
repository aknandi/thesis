...
temp = '/home/nandi1/Documents/PhD/thesis/temp/'
...
for commit in newcommits:
  ...
  def makeandcount(filename):
    makecmd = subprocess.Popen('./compile.sh', cwd = tmpdir, shell=True)
    makecmd.wait()
