...
%% Decay descriptors
\def\kpi {\decay{\Bm}{\D(\Km\pip)\Kstarm}\xspace}
\def\kk {\decay{\Bm}{\D(\Km\Kp)\Kstarm}\xspace}
\def\pipi {\decay{\Bm}{\D(\pim\pip)\Kstarm}\xspace}
\def\pik {\decay{\Bm}{\D(\pim\Kp)\Kstarm}\xspace}
\def\kpipipi {\decay{\Bm}{\D(\Km\pip\pim\pip)\Kstarm}\xspace}
\def\pipipipi {\decay{\Bm}{\D(\pim\pip\pim\pip)\Kstarm}\xspace}
\def\pikpipi {\decay{\Bm}{\D(\Kp\pim\pip\pim)\Kstarm}\xspace}
